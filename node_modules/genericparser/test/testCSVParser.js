...
describe("Csv parser",function(){
    it ("Should test OSM_MTP_Pharmacie.csv file",function(done){
        ...
        testCsv("csvhjk").parse(__dirname + "/files/input/OSM_MTP_Pharmacie.csv", function(result, index) {
            if (index == 1)
                stream.write("[");
            else if (result == null) {
                stream.write("]");
     ...
     it ("Should test OSM_MTP_Recyclage.csv file",function(done){
        ...
        testCsv("csvhjk").parse(__dirname + "/files/input/OSM_MTP_Recyclage.csv", function(result, index) {
            if (index == 1)
                stream.write("[");
            else if (result == null) {
                stream.write("]"); 
    ...
    it ("Should test OSM_MTP_Restaurants.csv csv file",function(done){
        ...
        testCsv("csvhjk").parse(__dirname + "/files/input/OSM_MTP_Restaurants.csv", function(result, index) {
            if (index == 1)
                stream.write("[");
            else if (result == null) {
                stream.write("]"); 
    ...
    it ("Should test OSM_MTP_StationService.csv file",function(done){
        ...
        testCsv("csvhjk").parse(__dirname + "/files/input/OSM_MTP_StationService.csv", function(result, index) {
            if (index == 1)
                stream.write("[");
            else if (result == null) {
                stream.write("]"); 
    ...
    it ("Should test OSM_MTP_TelephonePublic.csv file",function(done){
        ...
        testCsv("csvhjk").parse(__dirname + "/files/input/OSM_MTP_TelephonePublic.csv", function(result, index) {
            if (index == 1)
                stream.write("[");
            else if (result == null) {
                stream.write("]"); 
     ...
     it ("Should test VilleMTP_MTP_Elections_2012.csv file",function(done){
        ...
        testCsv("csvhjk").parse(__dirname + "/files/input/VilleMTP_MTP_Elections_2012.csv", function(result, index) {
            if (index == 1)
                stream.write("[");
            else if (result == null) {
                stream.write("]"); 
    ...
    it ("Should test VilleMTP_MTP_EtabliPublic_2011.csv file",function(done){
        ...
        testCsv("csvhjk").parse(__dirname + "/files/input/VilleMTP_MTP_EtabliPublic_2011_v3.csv", function(result, index) {
            if (index == 1)
                stream.write("[");
            else if (result == null) {
                stream.write("]"); 
    ...
    it ("Should test VilleMTP_MTP_FontainesPublic.csv file",function(done){
        ...
        testCsv("csvhjk").parse(__dirname + "/files/input/VilleMTP_MTP_FontainesPublic.csv", function(result, index) {
            if (index == 1)
                stream.write("[");
            else if (result == null) {
                stream.write("]"); 
