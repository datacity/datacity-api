...
describe("Csv parser",function(){
    ...
    it ("Should test OSM_MTP_Pharmacie.csv file",function(done){
     ...
     it ("Should test OSM_MTP_Recyclage.csv file",function(done){
        ...
        GenericParser("csv").parse(__dirname + "/files/input/OSM_MTP_Recyclage.csv", true, function(result, index) {
            if (index == 1)
                stream.write("[");
            else if (result == null) {
                stream.write("]"); 
    ...
    it ("Should test OSM_MTP_TelephonePublic.csv file",function(done){
     ...
     it ("Should test VilleMTP_MTP_Elections_2012.csv file",function(done){
        ...
        GenericParser("csv").parse(__dirname + "/files/input/VilleMTP_MTP_Elections_2012.csv", true, function(result, index) {
            if (index == 1)
                stream.write("[");
            else if (result == null) {
                stream.write("]"); 
