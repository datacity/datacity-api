...
<head>
	<meta charset="utf-8">
	<title>DataCity documentation tutorialREADME</title>
			...
			<ul class="nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu ">
						...
						<li>
							<a href="tutorial-README.html">README</a>
						</li>
						
						<li>
							<a href="tutorial-documentation.html">documentation</a>
						</li>
...
<article>
    <h1>Generic Parser</h1><h2>Installation</h2><pre><code>npm install genericParser
...
<h2>Tests</h2><p>pour le lancement des tests unitaires, nous utilisons le module <a href="https://github.com/visionmedia/mocha">mocha</a>. Il suffit de faire la manipulation suivante:  </p>
<pre><code>cd test
node mochaLauncher.js
</code></pre><p>Exemple de sortie : </p>
<pre><code class="lang-diff">Csv parser
...
<pre><code>sudo jsdoc ./lib/* README.md -t /usr/lib/node_modules/ink-docstrap/template/ -c /usr/lib/node_modules/ink-docstrap/template/jsdoc.conf.json -d ./documentation
		...
		on Thu Mar 13 2014 21:36:07 GMT+0300 (AST) 
		</span>
				</footer>
			</div>
