...
function parseCSV(fileName, noRam, callback) {
    var keys = [];
    var delimiter = "";
    var output = [];
    if (fs.existsSync(fileName) === false) {
        this.emit("error", new Error("Le fichier n'existe pas !"));
        return;
    }
    var that = this;
    ...
    fs.readFile(fileName, "utf8", function(err, data) {
      ...
      if (err)
            that.emit('error', new Error("problème dans la lecture du fichier lors du parsing"));
